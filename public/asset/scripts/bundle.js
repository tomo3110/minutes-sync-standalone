...
},{"select":16}],10:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
},{"./clipboard-action":9,"good-listener":15,"tiny-emitter":17}],11:[function(require,module,exports){
...
},{"closest":11}],14:[function(require,module,exports){
/**
...
},{"./is":14,"delegate":13}],16:[function(require,module,exports){
...
},{"ms":45}],22:[function(require,module,exports){
...
},{"./transport":25,"./transports":26,"component-emitter":32,"debug":20,"engine.io-parser":33,"indexof":40,"parsejson":46,"parseqs":47,"parseuri":48}],25:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":25,"component-inherit":19,"debug":20,"engine.io-parser":33,"parseqs":47,"xmlhttprequest-ssl":31,"yeast":65}],30:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":25,"component-inherit":19,"debug":20,"engine.io-parser":33,"parseqs":47,"ws":8,"yeast":65}],31:[function(require,module,exports){
...
},{"has-cors":39}],32:[function(require,module,exports){
...
},{"./keys":34,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":4,"blob":5,"has-binary":35,"utf8":62}],34:[function(require,module,exports){
...
module.exports = jQuery.fn.qrcode;
...
},{"./manager":50,"./socket":52,"./url":53,"debug":20,"socket.io-parser":56}],50:[function(require,module,exports){
...
},{"./on":51,"./socket":52,"backo2":3,"component-bind":18,"component-emitter":54,"debug":20,"engine.io-client":22,"indexof":40,"socket.io-parser":56}],51:[function(require,module,exports){
...
},{"./on":51,"component-bind":18,"component-emitter":54,"debug":20,"has-binary":37,"socket.io-parser":56,"to-array":61}],53:[function(require,module,exports){
(function (global){
...
},{"debug":20,"parseuri":48}],54:[function(require,module,exports){
...
},{"./is-buffer":57,"isarray":59}],56:[function(require,module,exports){
...
},{"./binary":55,"./is-buffer":57,"component-emitter":58,"debug":20,"isarray":59,"json3":60}],57:[function(require,module,exports){
(function (global){
...
},{"./rng":63}],65:[function(require,module,exports){
'use strict';
...
var _indentView = require('./indent.view.jsx');
    ...
    view: function view(ctrl, item) {
        return {
            ...
            children: [{
                ...
                children: [{
                    tag: 'h3',
                    children: [item.key + 1 + '. ' + item.title()]
                }, _mithril2.default.component(_indentView.IndentList, {
                    ...
                    addIndentSign: item.addIndentSign }, []), _mithril2.default.component(_indentView.IndentAdd, {
                    modalId: 'indent-modal-' + item.key,
                    callback: item.callback,
                    agendaIndex: item.key,
                    indent: typeof item.list[item.list.length - 1] !== 'undefined' ? item.list[item.list.length - 1].indent : _mithril2.default.prop(1)
                }, []), {
                    tag: 'hr'
                }],
                attrs: { className: 'col-xs-12' }
            }],
            attrs: { className: 'row', key: 'agenda-item-' + item.key }
        };
    }
};
...
var AgendaAdd = {
    ...
    view: function view(ctrl, addItem) {
        return {
            ...
            children: [{
                tag: 'h3',
                children: [addItem.agendaLength + 1 + '. ', {
                    tag: 'input',
                    attrs: { value: addItem.addAgendaTitle(),
                        className: 'agenda--item--input',
                        placeholder: '議題内容を入力',
                        oninput: _mithril2.default.withAttr('value', addItem.addAgendaTitle),
                        onkeypress: ctrl.keyPressed }
                }]
            }],
            attrs: { key: addItem.key }
        };
    }
};
...
var AgendaView = {
    view: function view(ctrl, props) {
        return {
            tag: 'div',
            children: [props.agendaList.map(function (item, index) {
                return _mithril2.default.component(AgendaItem, {
            ...
            }), _mithril2.default.component(AgendaAdd, {
                key: 'agend-add',
...
},{"./indent.view.jsx":71,"mithril":43}],67:[function(require,module,exports){
'use strict';
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            attrs: { className: 'sr-only' }
                        }, {
                            tag: 'span',
                            attrs: { className: 'icon-bar' }
                        }, {
                            tag: 'span',
                            attrs: { className: 'icon-bar' }
                        }, {
                    ...
                    children: [{
                        tag: 'ul',
                        children: [args.list.map(function (item) {
                            return _mithril2.default.component(HeaderItem, item, []);
                        })],
                        attrs: { className: 'nav navbar-nav' }
                    }],
    ...
    view: function view(ctrl, item) {
        return {
            ...
            children: [{
                tag: 'a',
                children: [item.name],
                attrs: { href: item.href || '#', config: _mithril2.default.route }
            }],
            attrs: { className: item.href === _mithril2.default.route() ? 'active' : '' }
        };
    }
};
...
},{"mithril":43}],69:[function(require,module,exports){
'use strict';
                    ...
                    case 1:
                        {
                            return {
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-ok-sign my-ok-icon', style: 'color: #2bc60b;' }
                            };
                        }
                    case 2:
                        {
                            return {
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-question-sign my-imp-icon', style: 'color: #e2142d;' }
                            };
                        }
                    case 3:
                        {
                            return {
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-info-sign my-info-icon', style: 'color: #e6a21e;' }
                            };
                        }
                    default:
                        {
...
},{"mithril":43}],70:[function(require,module,exports){
'use strict';
...
var _modalBase = require('./modal.base.jsx');

var _modalBase2 = _interopRequireDefault(_modalBase);

var _vm = require('../pages/minutes/vm');
    ...
    view: function view(ctrl, body) {
        return {
            ...
            children: [{
                ...
                children: [{
                    tag: 'label',
                    children: ['インデント:', body.indent()],
                    attrs: { htmlFor: 'message-text', className: 'control-label' }
                }, {
                    tag: 'textarea',
                    attrs: {
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-arrow-left' }
                            }],
                            attrs: { className: 'btn btn-default', onclick: body.callback.decrement }
                        }, {
                            tag: 'button',
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-arrow-right' }
                            }],
                            attrs: { className: 'btn btn-default', onclick: body.callback.increment }
                        }, {
                            tag: 'button',
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-remove' }
                            }],
                            attrs: { className: 'btn btn-default', onclick: body.callback.remove }
                        }, {
                            tag: 'button',
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-arrow-down' }
                            }],
                            attrs: { className: 'btn btn-default', onclick: body.callback.indentSplice }
                        }],
                        attrs: { className: 'btn-group', role: 'group' }
                    }],
                    attrs: { className: 'col-md-6', style: 'padding: 1rem;' }
                }, {
                    tag: 'section',
                    children: [{
                        tag: 'div',
                        children: [{
                            ...
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-ok-sign' }
                            }, '決定'],
                            attrs: {
                            ...
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-info-sign' }
                            }, '重要'],
                            attrs: {
                                className: 'btn btn-default',
                            ...
                            children: [{
                                tag: 'i',
                                attrs: { className: 'glyphicon glyphicon-question-sign' }
                            }, '課題'],
                            attrs: {
                                className: 'btn btn-default',
...
var IndentModalFooter = {
    view: function view(ctrl, footer) {
        return {
            tag: 'div',
            children: [{
                tag: 'button',
                children: ['編集終了'],
                attrs: { className: 'btn btn-default btn-block', onclick: footer.callback }
            }],
...
exports.IndentList = exports.IndentAdd = undefined;

var _mithril = require('mithril');

var _mithril2 = _interopRequireDefault(_mithril);

var _indentModal = require('./indent.modal.jsx');

var _indentModal2 = _interopRequireDefault(_indentModal);

var _indentIcon = require('./indent.icon.jsx');

var _indentIcon2 = _interopRequireDefault(_indentIcon);
...
var IndentItem = {
    controller: function controller(args) {
        ...
        this.isEdit = _mithril2.default.prop(false);
    },
    view: function view(ctrl, args) {
        return {
            tag: 'section',
            children: [{
                ...
                children: [{
                    tag: 'div',
                    children: [_mithril2.default.component(_indentIcon2.default, { sign: args.sign }, [])],
                    attrs: { className: 'col-xs-' + args.indent() + ' indent--item--blank', onclick: ctrl.open }
                }, {
                    tag: 'div',
                    children: [function () {
                        if (ctrl.isEdit()) {
                            return _mithril2.default.component(_indentModal2.default, {
                                id: args.modalId,
                        ...
                        tag: 'p',
                        children: [args.content() || 'タップして入力してください。'],
                        attrs: { className: 'indent--item--text', onclick: ctrl.open }
                    }],
                    attrs: { className: 'col-xs-' + (12 - args.indent()) + ' indent--item--content'
                    }
                }],
                attrs: { className: 'row' }
            }, _mithril2.default.component(IndentList, {
...
var IndentAdd = exports.IndentAdd = {
    controller: function controller(addItem) {
        var ctrl = this;
    ...
    view: function view(ctrl, addItem) {
        return {
            ...
            children: [{
                tag: 'div',
                attrs: { className: 'col-xs-' + addItem.indent() }
            }, {
                tag: 'div',
                children: [{
                    tag: 'p',
                    children: ['+  追加する'],
                    attrs: { className: 'indent--item--text__add', onclick: ctrl.clicked }
                }],
                attrs: { className: 'col-xs-' + (12 - addItem.indent()) }
            }],
            attrs: { className: 'row', key: addItem.modalId + '-add' }
        };
    }
};

var IndentList = exports.IndentList = {
    view: function view(ctrl, props) {
        return {
            tag: 'section',
            children: [props.list.map(function (item, index) {
                return _mithril2.default.component(IndentItem, {
            ...
            attrs: { className: 'indent__view--list' }
        };
    }
};

},{"./indent.icon.jsx":69,"./indent.modal.jsx":70,"mithril":43}],72:[function(require,module,exports){
'use strict';
...
},{"mithril":43}],73:[function(require,module,exports){
'use strict';
...
var MinutesAddInput = {
    controller: function controller(addMinutes) {
        var ctrl = this;
        this.newMinutesTitle = _mithril2.default.prop('');
        this.add = function () {
            ...
            children: [{
                ...
                children: [{
                    ...
                    children: [{
                        tag: 'button',
                        children: ['議事録の作成'],
                        attrs: { type: 'button', className: 'btn btn-success btn-' + (addMinutes.size || 'sm'), onclick: ctrl.add }
                    }],
...
exports.MinutesAttendanceAdd = exports.MinutesAttendanceItem = undefined;
...
var MinutesAttendanceItem = exports.MinutesAttendanceItem = {
            ...
            children: [{
                ...
                children: [{
                    ...
                    attrs: { type: 'text',
                        ...
                        id: 'list-' + item.index,
                        value: item.value(),
                        oninput: _mithril2.default.withAttr('value', item.value) }
                }],
                attrs: { className: 'input-group' }
            }],
            attrs: { className: 'form-group' }
...
var MinutesAttendanceAdd = exports.MinutesAttendanceAdd = {
    controller: function controller(addItem) {
        var ctrl = this;
        this.newEntry = _mithril2.default.prop('');
        this.add = function () {
        ...
        return {
            ...
            children: [{
                ...
                attrs: { type: 'text',
                    ...
                    onkeypress: ctrl.keypressed,
                    value: ctrl.newEntry(),
                    oninput: _mithril2.default.withAttr('value', ctrl.newEntry) }
            }],
            attrs: { className: 'input-group' }
        };
    }
...
var MinutesAttendance = {
    view: function view(ctrl, attendance) {
        return {
            tag: 'div',
            children: [{
                tag: 'h3',
                ...
                tag: 'section',
                children: [attendance.list.map(function (item, index) {
                    return _mithril2.default.component(MinutesAttendanceItem, {
                        value: item,
                        index: index,
                        removeAttendance: attendance.removeAttendance }, []);
                }), _mithril2.default.component(MinutesAttendanceAdd, { list: attendance.list, addAttendance: attendance.addAttendance }, [])],
...
},{"mithril":43}],75:[function(require,module,exports){
'use strict';
...
var _agendaView = require('./agenda.view.jsx');

var _agendaView2 = _interopRequireDefault(_agendaView);

var _minutesInfo = require('./minutes.info.jsx');

var _minutesInfo2 = _interopRequireDefault(_minutesInfo);
...
var Minutes = {
    view: function view(ctrl, args) {
        return {
            ...
            children: [{
                tag: 'h3',
                children: [args.data().title()]
            }, {
                tag: 'hr'
            }, _mithril2.default.component(_minutesInfo2.default, args.data(), []), {
                tag: 'hr'
            }, _mithril2.default.component(_agendaView2.default, {
...
},{"./agenda.view.jsx":66,"./minutes.info.jsx":76,"mithril":43}],76:[function(require,module,exports){
'use strict';
            ...
            children: [{
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            tag: 'b',
                            children: ['時　間:　']
                        }, (info.startTime() || '開始') + ' 〜 ' + (info.endTime() || '終了')]
                    }, {
                        tag: 'p',
                        children: [{
                            tag: 'b',
                ...
                children: [{
                    ...
                    if (info.entryList.length) {
                        return info.entryList.map(function (item) {
                            return '　' + item();
                        });
                    } else {
                        return '　誰と一緒に';
...
},{"mithril":43,"moment":44}],77:[function(require,module,exports){
'use strict';
...
var MinutesPanelItem = {
    controller: function controller(props) {
        this.clicked = function () {
            _mithril2.default.route('/minutes/' + props.minutes_id);
        };
    },
    view: function view(ctrl, props) {
        return {
            ...
            children: [{
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        attrs: { className: 'col-xs-3 col-sm-2 col-md-1', style: 'text-align: right;' }
                    }, {
                        tag: 'div',
                        children: [{
                            tag: 'p',
                            children: [props.day || 'いつ']
                        }],
                        attrs: { className: 'col-xs-9 col-sm-10 col-md-11', style: 'text-align: left;' }
                    }],
                    attrs: { className: 'row' }
                }, {
                    tag: 'div',
                    children: [{
                        ...
                        children: [{
                            tag: 'p',
                            children: [(props.startTime || '開始時間') + ' 〜 ' + (props.endTime || '終了時間')]
                        }],
                        attrs: { className: 'col-xs-9 col-sm-10 col-md-11', style: 'text-align: left;' }
                    }],
                    attrs: { className: 'row' }
            ...
            attrs: { className: 'panel panel-default projects__main', onclick: ctrl.clicked }
        };
    }
};

var MinutesPanelView = {
    view: function view(ctrl, args) {
        return {
            tag: 'div',
            children: [{
                ...
                children: [function () {
                    if (args.list.length > 0) {
                        return args.list.map(function (item) {
                            return _mithril2.default.component(MinutesPanelItem, item, []);
                        });
                    } else {
                        return {
                            tag: 'div',
...
},{"mithril":43}],78:[function(require,module,exports){
'use strict';
    ...
    view: function view(ctrl, item) {
        return {
            ...
            children: [{
                ...
                attrs: { className: 'col-sm-10 date' }
            }],
            attrs: { className: 'form-group' }
        };
    }
            ...
            children: [{
                ...
                children: [{
                    ...
                    attrs: { type: 'time',
                        ...
                        value: item.value(),
                        oninput: _mithril2.default.withAttr('value', item.value),
                        onclick: _mithril2.default.withAttr('value', item.value) }
                }, {
                    tag: 'datalist',
                    children: [{
                        tag: 'option',
        ...
        return {
            ...
            children: [{
                ...
                children: [{
                    tag: 'h3',
                    children: ['基本情報']
                }, _mithril2.default.component(MinutesSettingInput, {
                    value: setting.data().title,
                    label: 'タイトル',
                    type: 'text',
                    name: 'minutes-title-input' }, []), _mithril2.default.component(MinutesSettingInput, {
                    value: setting.data().where,
                    label: '場所',
                    type: 'text',
                    name: 'minutes-where-input' }, []), _mithril2.default.component(MinutesSettingInput, {
                    value: setting.data().secretary,
                    label: '書記',
                    type: 'text',
                    name: 'minutes-secretary-input' }, []), _mithril2.default.component(MinutesSettingDate, {
                    value: setting.data().day,
                    label: '日付',
                    name: 'minutes-date-input' }, []), _mithril2.default.component(MinutesSettingTime, {
                    ...
                    tag: 'p',
                    children: ['議事録を削除した場合、修復することはできません。']
                }, {
                    tag: 'button',
                    children: ['議事録を削除する'],
                ...
                attrs: { className: 'form-horizontal' }
            }],
            attrs: { className: 'content' }
        };
    }
...
},{"mithril":43}],79:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.minutesParse = minutesParse;
...
function indentParse() {
    var list = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
    var liSign = arguments.length <= 1 || arguments[1] === undefined ? "− " : arguments[1];

    var resolte = '';
    for (var i = 0; i < list.length; i++) {
        resolte += setIndet(list[i].indent) + liSign + list[i].content + setSign(list[i].sign) + nl + indentParse(list[i].children);
    }
    return resolte;
};
...
function agendaParse() {
    ...
    var resolte = '';
    for (var i = 0; i < list.length; i++) {
        resolte += i + 1 + '. ' + list[i].title + nl + indentParse(list[i].list, '・') + nl;
    }
    return resolte;
};
...
function minutesParse(args) {
    var data = jsonParse(args);
    return data.title + nl + border + nl + '場所　:　' + data.where + nl + '日付　:　' + data.day + nl + '時間　:　' + (data.startTime + ' 〜 ' + data.endTime) + nl + '書記　:　' + data.secretary + nl + '参加者:　' + data.entryList + nl + border + nl + agendaParse(data.agendaList) + border;
};

var MinutesShareCopy = {
    controller: function controller(item) {
        var ctrl = this;
        this.copy = function (element, init, context) {
            if (init) return false;
            var clipboard = new _clipboard2.default(element);
        };
    },
    view: function view(ctrl, item) {
        return {
...
var MinutesShareText = {
    controller: function controller(text) {
        var ctrl = this;
        this.copy = function (element, init, context) {
            if (init) return false;
            var clipboard = new _clipboard2.default(element);
    ...
    view: function view(ctrl, text) {
        return {
            ...
            children: [{
                ...
                children: [{
                    tag: 'textarea',
                    children: [minutesParse(text.data())],
                    attrs: { className: 'form-control', id: 'minutes-test-copy', rows: '25' }
                }],
                attrs: { className: 'form-group' }
            }, {
                tag: 'button',
...
var MinutesShare = {
    controller: function controller(share) {
        var ctrl = this;
        this.baseUrl = location.protocol + '//' + location.host + '/?' + _mithril2.default.route();
        this.config = function (element, init) {
            if (init) {
                (0, _jquery2.default)(element).html('');
                (0, _jquery2.default)(element).qrcode(ctrl.baseUrl);
            }
        };
    },
    view: function view(ctrl, share) {
        return {
            tag: 'div',
            children: [{
                tag: 'h3',
                ...
                tag: 'h3',
                children: ['テキストデータ']
            }, _mithril2.default.component(MinutesShareText, { data: share.data }, []), {
                tag: 'hr'
            }],
            attrs: { className: 'content' }
        };
...
},{"clipboard":10,"jquery":42,"jquery-qrcode":41,"mithril":43}],80:[function(require,module,exports){
'use strict';
...
var ModalBase = {
    view: function view(ctrl, modal) {
        return {
            tag: 'div',
            children: [{
                tag: 'div',
                attrs: { className: 'backdrop', onclick: modal.callback }
            }, {
                tag: 'div',
                children: [{
                    tag: 'div',
            ...
            attrs: { className: 'mymodal', id: modal.id }
        };
    }
};
...
},{"mithril":43}],81:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.TabContentList = exports.TabList = undefined;
    ...
    view: function view(ctrl, item) {
        return {
            ...
            children: [{
                tag: 'a',
                children: [item.title],
                attrs: { key: item.id, onclick: ctrl.onclicked }
            }],
            attrs: { className: item.active() === item.id ? 'active' : '' }
        };
    }
};

var TabList = exports.TabList = {
    view: function view(ctrl, props) {
        return {
            tag: 'ol',
            children: [props.list.map(function (item) {
                return _mithril2.default.component(TabItem, _extends({}, item, { active: props.active }), []);
            })],
            attrs: { className: 'nav nav-tabs' }
        };
    }
};
...
var TabContentList = exports.TabContentList = {
    view: function view(ctrl, props) {
        return {
            tag: 'div',
            children: [props.list.map(function (item) {
                return _mithril2.default.component(TabContentItem, _extends({}, item, { active: props.active }), []);
            })],
...
var TabView = {
    controller: function controller(args) {
        this.active = _mithril2.default.prop(args.active);
    },
    view: function view(ctrl, args) {
        return {
            tag: 'div',
            children: [_mithril2.default.component(TabList, { list: args.list, active: ctrl.active }, []), _mithril2.default.component(TabContentList, { list: args.list, active: ctrl.active }, [])]
        };
    }
};
...
},{"mithril":43}],82:[function(require,module,exports){
'use strict';
...
var _index = require('./pages/top/index.jsx');
...
var _indent = require('./indent.model');
...
var Agenda = function () {
    ...
    _createClass(Agenda, [{
        ...
        value: function addList(item) {
            this.list.push(new _indent2.default(item));
        }
    }, {
        key: 'addListAll',
        value: function addListAll() {
            var _this2 = this;
...
},{"./indent.model":84,"mithril":43}],84:[function(require,module,exports){
'use strict';
...
var Indent = function () {
    function Indent(args) {
        ...
        this.indent = _mithril2.default.prop(args.indent || 1);
        this.sign = _mithril2.default.prop(args.sign || 0);
        this.content = _mithril2.default.prop(args.content || '');
        this.isEdit = _mithril2.default.prop(false);
    ...
    _createClass(Indent, [{
        key: 'addChildren',
        value: function addChildren(item) {
            this.children.push(new Indent(item));
        }
    }, {
        key: 'addChildrenAll',
        value: function addChildrenAll() {
            var _this = this;

            var list = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

            list.map(function (item) {
                return _this.addChildren(item);
            });
        }
    }, {
        key: 'removeChildren',
        ...
        key: 'indentIncrement',
        value: function indentIncrement() {
            if (this.indent() === 11) return;
            this.indent(this.indent() + 1);
        }
    }, {
        key: 'indentDecrement',
        value: function indentDecrement() {
            if (this.indent() === 1) return;
            this.indent(this.indent() - 1);
        }
    }, {
        key: 'signOk',
        value: function signOk() {
            if (this.sign() === 1) {
                this.sign(0);
            } else {
                this.sign(1);
...
},{"mithril":43}],85:[function(require,module,exports){
'use strict';
...
var _agenda = require('./agenda.model');
...
var Minutes = function () {
    ...
    _createClass(Minutes, [{
        key: 'addAgendaList',
        value: function addAgendaList(item) {
            this.agendaList.push(new _agenda2.default(item));
        }
    }, {
        key: 'addAgendaListAll',
        value: function addAgendaListAll() {
            var _this = this;

            var list = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

            list.map(function (item) {
                return _this.addAgendaList(item);
            });
        }
    }, {
        key: 'addEntryList',
        ...
        key: 'addEntryListAll',
        value: function addEntryListAll() {
            var _this2 = this;

            var list = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

            list.map(function (item) {
                return _this2.addEntryList(item);
            });
        }
    }, {
        key: 'removeEntryList',
...
},{"./agenda.model":83,"mithril":43}],86:[function(require,module,exports){
'use strict';
...
var _minutesContent = require('../../components/minutes.content.jsx');

var _minutesContent2 = _interopRequireDefault(_minutesContent);

var _minutesShare = require('../../components/minutes.share.jsx');

var _minutesShare2 = _interopRequireDefault(_minutesShare);

var _minutesAttendance = require('../../components/minutes.attendance.jsx');
...
var Minutes = function () {
    function Minutes(vm) {
        ...
        this.controller = function () {
            ...
            return {
                ...
                newSign: vm.newSign,
                isEditTitle: _mithril2.default.prop(false),
                agendaAdd: function agendaAdd() {
                    vm.addAgendaItem();
                ...
                entryAdd: function entryAdd() {
                    var name = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];

                    vm.addEntryItem(name);
                    vm.dataSync(minutesId);
                },
                entryRemove: function entryRemove(index) {
    ...
    _createClass(Minutes, [{
        ...
        value: function view(ctrl) {
            return {
                tag: 'div',
                children: [_mithril2.default.component(_tab2.default, { active: 'minute-content', list: [{
                        id: 'minute-content',
                        title: '議事録',
                        content: _mithril2.default.component(_minutesContent2.default, {
                            data: ctrl.data,
                        ...
                        id: 'share-minutes',
                        title: '共有',
                        content: _mithril2.default.component(_minutesShare2.default, {
                            data: ctrl.data,
                ...
                attrs: { className: 'container-card' }
            };
        }
    }]);
...
var _minutes = require('../../models/minutes.model');
...
var minutes = {
    socket: function socket(minutesId) {
        ...
        minutes.io.on('update_serve', function (data) {
    ...
    dataSync: function dataSync(minutesId) {
    ...
    init: function init() {
        ...
        minutes.newIndent = _mithril2.default.prop(1);
        minutes.newSign = _mithril2.default.prop(0);
        minutes.newTitle = _mithril2.default.prop('');
        minutes.newWhere = _mithril2.default.prop('');
        minutes.newDay = _mithril2.default.prop('');
        minutes.newStartTime = _mithril2.default.prop('');
        minutes.newEndTime = _mithril2.default.prop('');
    }
};
...
var _minutesPanel = require('../../components/minutes.panel.jsx');

var _minutesPanel2 = _interopRequireDefault(_minutesPanel);

var _minutesAddInput = require('../../components/minutes.add.input.jsx');

var _minutesAddInput2 = _interopRequireDefault(_minutesAddInput);
...
var MinutesList = function () {
    function MinutesList(vm) {
        ...
        value: function view(ctrl) {
            return {
                ...
                children: [{
                    ...
                    tag: 'section',
                    children: [_mithril2.default.component(_minutesAddInput2.default, {}, [])],
                    attrs: { className: 'container-fluid' }
                }, _mithril2.default.component(_minutesPanel2.default, { list: ctrl.list }, [])],
                attrs: { className: 'container-fluid' }
            };
        }
    }]);
...
var _jumbotron = require('../../components/jumbotron.jsx');
    ...
    _createClass(Top, [{
        ...
        value: function view(ctrl) {
            return {
                ...
                children: [{
                    tag: 'div',
                    children: [_mithril2.default.component(_jumbotron2.default, {
                        content: _mithril2.default.component(_minutesAddInput2.default, { size: 'lg' }, []),
