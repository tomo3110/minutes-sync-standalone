...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = {}; // import '../css/main.scss';
	
	app.models = {};
	app.models.minutes = {
	    Item: function Item(args) {
	        this.project_id = _mithril2.default.prop(args.projects_id);
	        this.minutes_id = _mithril2.default.prop(args.minutes_id);
	        this.title = _mithril2.default.prop(args.title);
	        this.where = _mithril2.default.prop(args.where);
	        this.day = _mithril2.default.prop(args.day);
	        this.secretary = _mithril2.default.prop(args.secretary);
	        this.agenda = _mithril2.default.prop(args.agenda || []);
	    },
	...
	app.index.controller = function () {
	    return {
	        ...
	        submit: function submit(e) {
	            e.preventDefault();
	            socket.emit('update_client', { msg: _vm2.default.msg() });
	        }
	    };
	};
	app.index.view = function (ctrl) {
	    return {
	        tag: 'form',
	        children: [{
	            tag: 'h1',
	            ...
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.msg(), oninput: _mithril2.default.withAttr('value', _vm2.default.msg) }
	        }, {
	            tag: 'button',
	            children: ['submit'],
	            attrs: { className: 'btn btn-default', type: 'submit', onclick: ctrl.submit }
	        }]
	    };
	};
	    ...
	    return {
	        testSubmit: function testSubmit() {
	            ...
	            _mithril2.default.request({
	                method: "POST",
	                url: _api2.default.projects.new(),
	                data: rqData
	            }).then(function (data) {
	                console.log(data);
	            });
	        ...
	        testRead: function testRead() {
	            _mithril2.default.request({
	                method: "GET",
	                url: _api2.default.projects.index()
	            }).then(function (data) {
	                console.log(data);
	            });
	        },
	        testQuery: function testQuery(project_id) {
	            _mithril2.default.request({
	                method: "GET",
	                url: _api2.default.projects.show(projects_id)
	            }).then(function (data) {
	                console.log(data);
	            });
	        },
	        testUpdate: function testUpdate(project_id) {
	            _mithril2.default.request({
	                method: "PUT",
	                url: _api2.default.projects.update(project_id),
	                data: {
	                    title: '更新しました。',
	        ...
	        testDelete: function testDelete(project_id) {
	            _mithril2.default.request({
	                method: "DELETE",
	                url: _api2.default.projects.destroy(project_id),
	                data: {
	                    title: '更新しました。',
	                    text: 'テスト用のデータを更新しました。'
	                }
	...
	app.test.view = function view(ctrl) {
	    return {
	        ...
	        children: [{
	            tag: 'button',
	            children: ['submit'],
	            attrs: { className: 'btn btn-default', type: 'button', onclick: ctrl.testSubmit }
	        }, {
	            tag: 'button',
	            children: ['read'],
	            attrs: { className: 'btn btn-default', type: 'button', onclick: ctrl.testRead }
	        }, {
	            tag: 'button',
	            children: ['query'],
	            attrs: { className: 'btn btn-default', type: 'button', onclick: function onclick() {
	                    return ctrl.testQuery('00ba01c7-79ba-44ff-9f7a-6ae86e0c3532');
	                } }
	        }, {
	            tag: 'button',
	            children: ['update'],
	            attrs: { className: 'btn btn-default', type: 'button', onclick: function onclick() {
	                    return ctrl.testUpdate('00ba01c7-79ba-44ff-9f7a-6ae86e0c3532');
	                } }
	        }]
	    };
	};
	...
	app.minutes.view = function (ctrl) {
	    return {
	        ...
	        children: [{
	            tag: 'button',
	            children: ['submit'],
	            attrs: { className: 'btn btn-primary', type: 'submit', onclick: ctrl.submit }
	        }, {
	            tag: 'button',
	            children: ['add'],
	            attrs: { className: 'btn btn-default', type: 'submit', onclick: ctrl.add }
	        }, {
	            tag: 'a',
	            children: ['go minutes show'],
	            attrs: { harf: '/minutes/' + '45cd76e6-c327-4e6f-9925-a9dbdd2379e3', config: _mithril2.default.route }
	        }]
	    };
	};
	...
	app.minutesShow.controller = function () {
	    ...
	    return {
	        init: _mithril2.default.request({
	            method: "GET",
	            url: _api2.default.minutes.show(_mithril2.default.route.param('minutes_id'))
	        }).then(function (data) {
	            _mithril2.default.startComputation();
	            console.log(data);
	            console.log(_mithril2.default.route.param());
	            _vm2.default.minutes(new app.models.minutes.Item(data));
	            _mithril2.default.endComputation();
	        }),
	        submit: function submit(e) {
	            e.preventDefault();
	            minutesIo.emit('update_client', { minutes: _vm2.default.minutes() });
	        },
	...
	app.minutesShow.view = function (ctrl) {
	    return {
	        tag: 'form',
	        children: [{
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.minutes().title(), oninput: _mithril2.default.withAttr('value', _vm2.default.minutes().title) }
	        }, {
	            tag: 'br'
	        }, {
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.minutes().project_id(), oninput: _mithril2.default.withAttr('value', _vm2.default.minutes().project_id) }
	        }, {
	            tag: 'br'
	        }, {
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.minutes().day(), oninput: _mithril2.default.withAttr('value', _vm2.default.minutes().day) }
	        }, {
	            tag: 'br'
	        }, {
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.minutes().secretary(), oninput: _mithril2.default.withAttr('value', _vm2.default.minutes().secretary) }
	        }, {
	            tag: 'br'
	        }, {
	            tag: 'input',
	            attrs: { type: 'text', value: _vm2.default.minutes().where(), oninput: _mithril2.default.withAttr('value', _vm2.default.minutes().where) }
	        }, {
	            tag: 'br'
	        }, {
	            tag: 'button',
	            children: ['submit'],
	            attrs: { className: 'btn btn-default', onclick: ctrl.submit }
	        }]
	    };
	};
	...
	app.users.controller = function () {
	    var respon = {
	        ...
	        submit: function submit(e) {
	            ...
	            _mithril2.default.request({
	                method: 'POST',
	                url: _api2.default.users.signIn(),
	                data: {
	                    email: respon.email(),
	        ...
	        userCheck: function userCheck(e) {
	            ...
	            _mithril2.default.request({
	                method: 'GET',
	                url: _api2.default.users.index()
	            }).then(function (data) {
	                console.log(data);
	            });
	        },
	        signCheck: function signCheck(e) {
	            e.preventDefault();
	            _mithril2.default.request({
	                method: 'GET',
	                url: _api2.default.users.signCheck()
	            }).then(function (data) {
	                console.log(data);
	            });
	        },
	        logout: function logout(e) {
	            ...
	            _mithril2.default.request({
	                method: 'GET',
	                url: _api2.default.users.signOut()
	            }).then(function (data) {
	                console.log(data);
	            });
	        }
	...
	app.users.view = function (ctrl) {
	    return (0, _mithril2.default)('form', [(0, _mithril2.default)('input', {
	        'type': 'email',
	        'value': ctrl.email(),
	        'oninput': _mithril2.default.withAttr('value', ctrl.email)
	    }), (0, _mithril2.default)('input', {
	        'type': 'password',
	        'value': ctrl.password(),
	        'oninput': _mithril2.default.withAttr('value', ctrl.password)
	    }), (0, _mithril2.default)('button', {
	        'onclick': ctrl.submit
	    }, 'login'), (0, _mithril2.default)('button', {
	        'onclick': ctrl.logout
	    }, 'logout'), (0, _mithril2.default)('button', {
	        'onclick': ctrl.userCheck
	    }, 'crrentUser check'), (0, _mithril2.default)('button', {
	        'type': 'button',
	...
	*/
	...
	_mithril2.default.route(document.getElementById('content'), '/', {
	    '/': app.index,
	    '/test': app.test,
	    '/minutes': app.minutes,
	    '/minutes/:minutes_id': app.minutesShow,
	    '/:project_id/:minutes_id': app.minutesShow,
	    '/users': app.users
	});
...
/***/ function(module, exports) {
	...
	var api = {
	    ...
	    projects: {
	        ...
	        show: function show(projectsId) {
	            return api.baseUrl + '/projects/' + projectsId;
	        },
	        update: function update(projectsId) {
	            return api.baseUrl + '/projects/' + projectsId;
	        },
	        destroy: function destroy(projectsId) {
	            return api.baseUrl + '/projects/' + projectsId;
	        }
	    },
	    minutes: {
	        index: function index() {
	            return api.baseUrl + '/minutes';
	        },
	        new: function _new() {
	            return api.baseUrl + '/minutes';
	        },
	        show: function show(minutesId) {
	            return api.baseUrl + '/minutes/' + minutesId;
	        },
	        update: function update(minutesId) {
	            return api.baseUrl + '/minutes/' + minutesId;
	        },
	    ...
	    users: {
	        ...
	        signUp: function signUp() {
	            return api.baseUrl + '/users/signUp';
	        },
	        signIn: function signIn() {
	            return api.baseUrl + '/users/signIn';
	        },
	        signOut: function signOut() {
	            return api.baseUrl + '/users/signOut';
	        },
	        signCheck: function signCheck() {
	            return api.baseUrl + '/users/sign';
	        }
	    }
	};
